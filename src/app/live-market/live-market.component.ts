...
import { chartCandleDefaultOptions, chartBarDefaultOptions } from 'src/app/live-market/chart.config';
import {
  ChartComponent,
  ApexAxisChartSeries,
  ApexChart,
...
export class LiveMarketComponent {
  ...
  constructor() {
    this.chartCandleOptions = {
      ...
      ...(chartCandleDefaultOptions as Partial<ChartOptions>),
    };
    ...
    this.chartBarOptions = {
      ...
      ...(chartBarDefaultOptions as Partial<ChartOptions>),
    };
  }
}
